...
TypeAssignment : TYPE_OR_MODULE_REFERENCE '::=' Type { StagedAssignment (WithName $1 (TypeAssignment $3)) }

ValueAssignment : IDENTIFIER_OR_VALUE_REFERENCE Type '::=' Value { StagedAssignment (WithName $1 (ValueAssignment $2 $4)) }
...
definesType name (TypeRefUnparsedValue (StagedAssignment a)) = (isNamed name a) && (isTypeAssigned (stripName a))
...
findTypeByName as n = case find (definesType n) as of Nothing -> error ("could not resolve reference to type " ++ n)
                                                      Just (TypeRefUnparsedValue (StagedAssignment (WithName _ (TypeAssignment t)))) -> t

resolveTypeComponents :: [ASN1AssignmentTypeRefUnparsedValue] -> ASN1TypeWithRef -> ASN1TypeNoRef
resolveTypeComponents as (TypeWithRef t) = TypeNoRef (tfmap (resolveTypeCompletely as) id id t)
...
parseValueInAssignment (UnparsedValue (StagedAssignment x)) = IntRef (dfmap parseValuesInType (parseValueByType ((typeFromAssigned . stripName) x)) (StagedAssignment x))
...
resolveValuesInType as (TypeValParsed t) = Type (tfmap (resolveValuesInType as) (resolveValueComponents as) (resolveIntegerReference as) t)
...
findIntegerByName as n = case find (isIntegerNamed n) as of Nothing -> error ("could not resolve reference to integer " ++ n)
                                                            Just (IntRef (StagedAssignment (WithName _ (ValueAssignment  _ (IntegerValue r))))) -> r

isIntegerNamed :: String -> ASN1AssignmentIntRef -> Bool
isIntegerNamed name (IntRef (StagedAssignment (WithName n (ValueAssignment _ (IntegerValue _))))) = n == name
...
tests = [testParse "TypeA ::= BOOLEAN"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type BooleanType))))],
         testParse "TypeA ::= TypeB TypeB ::= BOOLEAN"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type BooleanType)))), Assignment (StagedAssignment (WithName "TypeB" (TypeAssignment (Type BooleanType))))],
         testParse "TypeA ::= CHOICE { bool BOOLEAN }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment ((Type ChoiceType {choices=[WithName "bool" (Type BooleanType)]})))))],
         testParse "TypeA ::= INTEGER { two(2) }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment ((Type IntegerType {namedIntegerValues=Just [WithName "two" 2]})))))],
         testParse "TypeA ::= SEQUENCE OF TypeB TypeB ::= BOOLEAN"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceOfType (Unnamed (Type BooleanType))))))), Assignment (StagedAssignment (WithName "TypeB" (TypeAssignment (Type BooleanType))))],
         testParse "TypeA ::= SEQUENCE OF bool BOOLEAN"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceOfType (Named (WithName "bool" (Type BooleanType))))))))],
         testParse "TypeA ::= SEQUENCE { }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [] [] [])))))],
         testParse "TypeA ::= SEQUENCE { boolA BOOLEAN , boolB BOOLEAN }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [Required (WithName "boolA" (Type BooleanType)),Required (WithName "boolB" (Type BooleanType))] [] [])))))],
         testParse "TypeA ::= SEQUENCE { boolA BOOLEAN OPTIONAL }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [Optional (WithName "boolA" (Type BooleanType))] [] [])))))],
         testParse "TypeA ::= SEQUENCE { boolA BOOLEAN, ... }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [Required (WithName "boolA" (Type BooleanType))] [] [])))))],
         testParse "TypeA ::= SEQUENCE { ... , ... , boolA BOOLEAN }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [] [] [Required (WithName "boolA" (Type BooleanType))])))))],
         testParse "TypeA ::= SEQUENCE { ... , boolA BOOLEAN , ... }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [] [[Required (WithName "boolA" (Type BooleanType))]] [])))))],
         testParse "TypeA ::= SEQUENCE OF CHOICE { b BOOLEAN , i INTEGER }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceOfType (Unnamed (Type (ChoiceType {choices=[WithName "b" (Type BooleanType), WithName "i" (Type (IntegerType {namedIntegerValues=Nothing}))]}))))))))],
         testParse "TypeA ::= SEQUENCE OF SEQUENCE { b BOOLEAN, ... , ...}"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceOfType (Unnamed (Type (SequenceType [Required (WithName "b" (Type BooleanType))] [] []))))))))],
         testParse "TypeA ::= ENUMERATED { red, green }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (EnumeratedType [UnnumberedEnumerationEntry "red", UnnumberedEnumerationEntry "green"] Nothing)))))],
         testParse "TypeA ::= ENUMERATED { red(1), green, blue(2) }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (EnumeratedType [NumberedEnumerationEntry (WithName "red" (Builtin 1)), UnnumberedEnumerationEntry "green", NumberedEnumerationEntry (WithName "blue" (Builtin 2))] Nothing)))))],
         testParse "TypeA ::= BIT STRING"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (BitStringType {namedBits = Nothing})))))],
         testParse "TypeA ::= BIT STRING { omit-start(0), omit-end(1) }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (BitStringType {namedBits = Just [WithName "omit-start" 0, WithName "omit-end" 1]})))))],
         testParse "TypeA ::= SEQUENCE OF OCTET STRING"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment  (Type (SequenceOfType (Unnamed (Type OctetStringType)))))))],
         testParse "valueA BOOLEAN ::= TRUE"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type BooleanType, assignmentValue=BooleanValue True})))],
         testParse "valueA TypeA ::= FALSE TypeA ::= BOOLEAN"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type BooleanType, assignmentValue=BooleanValue False}))), (Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment {asn1Type=(Type BooleanType)}))))],
         testParse "valueA INTEGER ::= -5"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (IntegerType {namedIntegerValues=Nothing}), assignmentValue=IntegerValue (-5)})))],
         testParse "valueA INTEGER {five(5)} ::= two two INTEGER ::= 2"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (IntegerType {namedIntegerValues= Just [WithName "five" 5]}), assignmentValue=IntegerValue 2}))), Assignment (StagedAssignment (WithName "two" (ValueAssignment {asn1Type=Type (IntegerType Nothing), assignmentValue= IntegerValue 2})))],
         testParse "valueA CHOICE {choiceA BOOLEAN } ::= choiceA : TRUE"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (ChoiceType {choices=[WithName "choiceA" (Type BooleanType)]}), assignmentValue=ChoiceValue "choiceA" (BooleanValue True)})))],
         testParse "valueA BIT STRING ::= \'0000\'B"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (BitStringType {namedBits=Nothing}), assignmentValue=BitStringValue [B0,B0,B0,B0]})))],
         testParse "valueA BIT STRING ::= \'3\'H"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (BitStringType {namedBits=Nothing}), assignmentValue=BitStringValue [B0,B0,B1,B1]})))],
         testParse "TypeA ::= TypeC TypeB ::= OCTET STRING TypeC ::= TypeB"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type OctetStringType)))), Assignment (StagedAssignment (WithName "TypeB" (TypeAssignment (Type OctetStringType)))), Assignment (StagedAssignment (WithName "TypeC" (TypeAssignment (Type OctetStringType))))],
         testParse "TypeA ::= CHOICE { c TypeB } TypeB ::= CHOICE { c TypeC } TypeC ::= BOOLEAN"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (ChoiceType {choices=[WithName "c" (Type (ChoiceType {choices=[WithName "c" (Type BooleanType)]}))]}))))), Assignment (StagedAssignment (WithName "TypeB" (TypeAssignment (Type (ChoiceType {choices=[WithName "c" (Type BooleanType)]}))))), Assignment (StagedAssignment (WithName "TypeC" (TypeAssignment (Type BooleanType))))],
         testParse "valueA OCTET STRING ::= \'1\'B"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type OctetStringType, assignmentValue=OctetStringValue[(B1,B0,B0,B0,B0,B0,B0,B0)]})))],
         testParse "valueA OCTET STRING ::= \'33\'H"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type OctetStringType, assignmentValue=OctetStringValue[(B0,B0,B1,B1,B0,B0,B1,B1)]})))],
         testParse "TypeA ::= SEQUENCE { a BOOLEAN DEFAULT TRUE }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [Default (WithName "a" (Type BooleanType)) (BooleanValue True)] [] [])))))],
         testParse "TypeA ::= SEQUENCE { b BIT STRING DEFAULT \'10\'B }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceType [Default (WithName "b" (Type BitStringType {namedBits = Nothing})) (BitStringValue [B1,B0])] [] [])))))],
         testParse "TypeA ::= SEQUENCE OF CHOICE { s SEQUENCE { o OCTET STRING DEFAULT \'F\'H } }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (SequenceOfType (Unnamed (Type (ChoiceType {choices=[WithName "s" (Type (SequenceType [Default (WithName "o" (Type OctetStringType)) (OctetStringValue [(B1,B1,B1,B1,B0,B0,B0,B0)])] [] []))]}))))))))],
         testParse "valueA SEQUENCE OF BOOLEAN ::= { TRUE , FALSE }"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (SequenceOfType (Unnamed (Type BooleanType))), assignmentValue=SequenceOfValue [BooleanValue True, BooleanValue False]})))],
         testParse "valueA ENUMERATED { a , b } ::= a"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (EnumeratedType [UnnumberedEnumerationEntry "a", UnnumberedEnumerationEntry "b"] Nothing), assignmentValue=EnumeratedValue "a"})))],
         testParse "valueA SEQUENCE { b BOOLEAN, c CHOICE { b BOOLEAN } } ::= { b FALSE , c b : TRUE }"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (SequenceType [Required (WithName "b" (Type BooleanType)), Required (WithName "c" (Type (ChoiceType {choices=[WithName "b" (Type BooleanType)]})))] [] []), assignmentValue=SequenceValue [WithName "b" (BooleanValue False), WithName "c" (ChoiceValue {chosen="b", choiceValue=BooleanValue True})]})))],
         testParse "valueA NULL ::= NULL"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type NullType, assignmentValue=NullValue})))],
         testParse "TypeA ::= ENUMERATED { a, b , ... }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (EnumeratedType [UnnumberedEnumerationEntry "a", UnnumberedEnumerationEntry "b"] (Just []))))))],
         testParse "TypeA ::= ENUMERATED { a, ... , b }"
                   [Assignment (StagedAssignment (WithName "TypeA" (TypeAssignment (Type (EnumeratedType [UnnumberedEnumerationEntry "a"] (Just [UnnumberedEnumerationEntry "b"]))))))],
         testParse "valueA INTEGER { five(5) } ::= five"
                   [Assignment (StagedAssignment (WithName "valueA" (ValueAssignment {asn1Type=Type (IntegerType {namedIntegerValues = Just [WithName "five" 5]}), assignmentValue=IntegerValue 5})))]
        ] ++ lexerTests
